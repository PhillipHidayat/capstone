...
const [circles_to_draw, setCircles] = useState();
const [comments, setCommments] = useState(new Map());
...
const handleCoords = (x, y) => {
  ...
  return (
    ...
    <div className="App" >
      ...
      <DiagnosisPopup X = {xCoord} Y = {yCoord} trigger= {popupVisible} setTrigger= {setPopupVisible} delete_circle={delete_circle} circle_key={key} onSave={reloadPDF} image={imagePath} ></DiagnosisPopup>
