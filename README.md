...
```
cd existing_repo
git remote add origin https://capstone-cs.eng.utah.edu/medcapture/medcapture.git
git branch -M main
...
- [ ] [Set up project integrations](https://capstone-cs.eng.utah.edu/medcapture/medcapture/-/settings/integrations)
